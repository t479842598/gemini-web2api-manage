...
from .gemini import load_cookie, make_sapisidhash, _account_prefix, _gemini_base_url, _get_ssl_ctx, log
...
def _get_page_tokens() -> dict:
    ...
    try:
        req = urllib.request.Request(f"{_gemini_base_url()}{_account_prefix()}/app", headers=headers)
